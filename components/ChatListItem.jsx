...
function ChatListItem({ id, name, discipline, color, metric, lastMessagePreview, isActive, onSelect }) {
    return (<button onClick={() => onSelect(id)} className={`group flex w-full items-center gap-3 rounded-[16px] px-3 py-3 text-left transition-all duration-150 ${isActive
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 truncate text-[12px] text-[#7c96a4]">{discipline} / {metric}</p>
