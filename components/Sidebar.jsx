...
export default function Sidebar({ projects, activeProjectId, onSelectProject, isOpen, onClose }) {
    ...
    return (<>
      ...
      <aside className={`fixed left-3 right-3 top-[4.8rem] z-40 flex h-[calc(100dvh-5.8rem)] flex-col rounded-[24px] border border-[#1b303c] bg-[#0a161e] shadow-[0_18px_50px_rgba(0,0,0,0.35)] transition-all duration-300 ease-in-out md:relative md:left-auto md:right-auto md:top-auto md:z-auto md:h-full md:w-[314px] md:flex-shrink-0 md:rounded-none md:border-0 md:border-r md:border-[#162a35] md:shadow-none
